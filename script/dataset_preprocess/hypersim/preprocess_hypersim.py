...
if "__main__" == __name__:
    ...
    parser.add_argument(
        "--split_csv",
        type=str,
        default="/scratch/ansh.shah/ml-hypersim/evermotion_dataset/analysis/metadata_images_split_scene_v1.csv",
    )
    # parser.add_argument("--dataset_dir", type=str, default="data/Hypersim/raw_data")
    parser.add_argument("--dataset_dir", type=str, default="/scratch/ansh.shah/ml-hypersim/evermotion_dataset/scenes")
    parser.add_argument("--output_dir", type=str, default="/scratch/ansh.shah/Hypersim/processed")
